...
fn exec_already_bundled(ctx: Context) -> Result<(), crate::Error> {
    ...
    for entry in entry_points {
        ...
        let mut js_path_buf = bun_paths::path_buffer_pool::get();
        ...
        let mut jsc_path_buf = bun_paths::path_buffer_pool::get();
        ...
        if is_esm {
            ...
            let mut mi_path_buf = bun_paths::path_buffer_pool::get();
            let Some(mi_path) =
